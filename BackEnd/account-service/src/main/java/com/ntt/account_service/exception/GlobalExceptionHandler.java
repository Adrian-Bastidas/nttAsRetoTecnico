...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(DiferentesTiposException.class)
    public ResponseEntity<Object> handleNotCoincidenceException(DiferentesTiposException ex) {
        logger.error("Error en el tipo de cuenta: {}", ex.getMessage(), ex);
        return buildResponse(HttpStatus.FORBIDDEN, "Error en el tipo de cuenta", ex.getMessage());
    }
